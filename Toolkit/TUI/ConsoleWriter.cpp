...
void Tui::ProgressBar::Render() const {
    ...
    /* Дополнительные пробелы в конце — на случай если предыдущая
               строка (например, лейбл или значения) была длиннее текущей;
               иначе хвост старого текста останется视имым справа. */
    line << "    ";
